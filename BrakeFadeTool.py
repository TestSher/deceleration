...
def init():
    ...
    img = PIL.Image.open('images/LR_gauge.png')
    ...
    def rotate_pointer(degree1):
        ...
        y = 400 - 260 * math.sin(((2 * math.pi) / 360.0) * degree)
        my_line = my_canvas.create_line(367, 400, x, y, fill='black', width=10)
        my_line1 = my_canvas.create_line(367, 400, x, y, fill='white', width=3)
    ...
    def serial_task():
        ...
        if x != None:
            ...
            #print(f'{currtime}, {x[0]}, {x[1]}, {x[2]}, {v}')
            f.write(f'{currtime:.3f}, {x[0]:.3f}, {x[1]}, {x[2]}, {v}\n')
